...
// /pronounce, kể cả chấm theo từng câu nói ở Guided/Exploration — xem
// lib/pronunciationScoring.ts). error_type trong word_scores là TIP cải thiện tiếng
// Việt (map tĩnh từ mã lỗi Azure, xem ERROR_TIP_MAP trong
// supabase/functions/_shared/azurePronunciation.ts), không phải mã lỗi thô; score luôn = 0.

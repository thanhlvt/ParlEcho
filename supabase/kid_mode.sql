...
-- 36. Bù sticker bị bỏ sót — vanilla/strawberry (mission mẫu không gắn) và sticker-93..100
-- (95 sticker đánh số dư ra do 29 mission × 3 chỉ dùng hết 87/95). Thêm 2 sticker mới
-- (gem + bánh sinh nhật) để đủ 12 sticker = 4 mission × 3, không mission nào thiếu/dư.
insert into stickers (id, name, theme, emoji, sort_order) values
